...
// ngmg.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CngmgApp, CWinApp)
...
// Единственный объект CngmgApp

CngmgApp theApp;


// Инициализация CngmgApp

BOOL CngmgApp::InitInstance()
{
